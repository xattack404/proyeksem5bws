                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="gambartabel"><img  src="{{ asset('buktipembayaran/'. $pembayaran->bukti_pembayaran) }}" width='75' height='75'></td>
                                <td class="gambartabel"><img  src="{{ asset('scn_ijz/'. $pembayaran->registrasi->file_ijazah) }}" width='75' height='75'></td>
