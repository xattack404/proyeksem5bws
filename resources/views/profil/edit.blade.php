  ...
  <div class="section-body">
    <div class="col-12 col-md-6 col-lg-6">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('profil.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="_method" value="PUT">
            @csrf
            <div class="form-group">
              <label>Name Pondok</label>
              <input type="text" name="nama_pondok" class="form-control" value="{{ $data->nama_pondok }}">
            </div>
            <div class="form-group">
              <label>Visi</label>
              <input type="text" name="visi" class="form-control" value="{{ $data->visi }}">
            </div>
            <div class="form-group">
              <label>Misi</label>
              <input type="text" name="misi" class="form-control" value="{{ $data->misi }}">
            </div>
            <div class="form-group">
