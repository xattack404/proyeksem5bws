...
Route::get('/artikel/{seo}', ['as' => 'frontend.home.artikel', 'uses' => 'IndexController@artikel']);
...
Route::get('cekdata/form', ['as' => 'frontend.cekdata.form', 'uses' => 'CekdataController@kontak']);
